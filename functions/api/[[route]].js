...
const SEED_QUESTIONS = [
  {qnum:1,type:"verbal",skill_id:"v4",text:"الغِيبة : القطيعة — كـ —",opt1:"الصدق : الثقة",opt2:"الكذب : الريبة",opt3:"الوفاء : الخيانة",opt4:"العدل : الظلم",ans:1},
  {qnum:2,type:"verbal",skill_id:"v4",text:"الترياق : السم — كـ —",opt1:"الثناء : المدح",opt2:"العقاب : الجريمة",opt3:"الاعتذار : الإساءة",opt4:"الوعد : الإخلاف",ans:2},
  {qnum:3,type:"verbal",skill_id:"v4",text:"غفّار : غافر — كـ —",opt1:"طويل : طوال",opt2:"كاتب : قارئ",opt3:"شجاع : قوي",opt4:"رحيم : راحم",ans:3},
  {qnum:4,type:"verbal",skill_id:"v4",text:"الإشاعة : الفتنة — كـ —",opt1:"القطرة : الغيث",opt2:"الفكرة : الاختراع",opt3:"الكلمة : الحوار",opt4:"الشرارة : الحريق",ans:3},
  {qnum:5,type:"verbal",skill_id:"v4",text:"التلميح : التصريح — كـ —",opt1:"الهمس : الصراخ",opt2:"الغموض : الإيضاح",opt3:"السؤال : الجواب",opt4:"الكتابة : القراءة",ans:0},
  {qnum:6,type:"verbal",skill_id:"v5",text:"من ملك ......... نفسه عند الغضب، ملك ......... الناس عند الرضا.",opt1:"هوى - كره",opt2:"زمام - قلوب",opt3:"غضب - رضا",opt4:"أمر - مال",ans:1},
  {qnum:7,type:"verbal",skill_id:"v5",text:"الجاهل ......... بجهله، والعالم ......... من قلة علمه.",opt1:"يخجل - يفخر",opt2:"يتباهى - يفتخر",opt3:"يفخر - يخجل",opt4:"يجهل - يعلم",ans:2},
  {qnum:8,type:"verbal",skill_id:"v5",text:"من ......... لسانه ......... نفسه، ومن ......... غضبه كسب رضا الناس.",opt1:"أطلق - أهلك - فقد",opt2:"حفظ - صان - ملك",opt3:"أطلق - صان - ملك",opt4:"حفظ - أهلك - فقد",ans:1},
  {qnum:9,type:"verbal",skill_id:"v5",text:"من كثُر ......... قلّ ......... ، فالكلامُ إذا زاد نَقُصَ سمتُ صاحبه.",opt1:"صمته - كلامه",opt2:"علمه - جهله",opt3:"ماله - فقره",opt4:"كلامه - وقاره",ans:3},
  {qnum:10,type:"verbal",skill_id:"v5",text:"إنما ......... الرجالُ بأخلاقهم، لا ......... بأموالهم.",opt1:"تُنقص - تُقاس",opt2:"تُمدح - تُذم",opt3:"تُقاس - تُقاس",opt4:"تُقاس - تُنقص",ans:2},
  {qnum:11,type:"verbal",skill_id:"v2",text:"حدّد الكلمة التي جاء استخدامها غير مناسب سياقياً ومنطقياً بالنظر إلى الجملة كاملة، وإن كانت صحيحة لغوياً في ذاتها:\n\nالصبرُ مفتاح الفرج (أ)، ومن استعجل (ب) الأمر قبل توقيته (ج) كوفئ (د) بإدراكه.",opt1:"أ",opt2:"ب",opt3:"ج",opt4:"د",ans:3},
  {qnum:12,type:"verbal",skill_id:"v2",text:"حدّد الكلمة التي جاء استخدامها غير مناسب سياقياً ومنطقياً بالنظر إلى الجملة كاملة، وإن كانت صحيحة لغوياً في ذاتها:\n\nالكريمُ يبذلُ (أ) عطاءه ولو لم يُسأل، أما البخيلُ فيبذلُ (ب) عطاءه ولو أُلِحَّ عليه طويلاً (ج)، ذلك أنَّ المنعَ سجيةٌ راسخةٌ (د) فيمن بخُل.",opt1:"أ",opt2:"ب",opt3:"ج",opt4:"د",ans:1},
  {qnum:13,type:"verbal",skill_id:"v2",text:"حدّد الكلمة التي جاء استخدامها غير مناسب سياقياً ومنطقياً بالنظر إلى الجملة كاملة، وإن كانت صحيحة لغوياً في ذاتها:\n\nالعلمُ يزيد (أ) بالبذل والعطاء، والمالُ ينقص (ب) بالبذل والعطاء، فمن أراد أن يكثر علمه فلينقص (ج) من تعليمه للناس (د).",opt1:"أ",opt2:"ب",opt3:"ج",opt4:"د",ans:2},
  {qnum:14,type:"verbal",skill_id:"v2",text:"حدّد الكلمة التي جاء استخدامها غير مناسب سياقياً ومنطقياً بالنظر إلى الجملة كاملة، وإن كانت صحيحة لغوياً في ذاتها:\n\nالوقتُ كالسيف إن لم تقطعه (أ) قطعك (ب)، فمن أضاعه كانت الحياةُ في خدمته (ج)، ومن ملك وقته ملك حياته (د).",opt1:"أ",opt2:"ب",opt3:"ج",opt4:"د",ans:2},
  {qnum:15,type:"verbal",skill_id:"v2",text:"حدّد الكلمة التي جاء استخدامها غير مناسب سياقياً ومنطقياً بالنظر إلى الجملة كاملة، وإن كانت صحيحة لغوياً في ذاتها:\n\nمن زرع (أ) المعروف حصد (ب) الشكر، ومن زرع الإساءة حصد (ج) المحبة (د).",opt1:"أ",opt2:"ب",opt3:"ج",opt4:"د",ans:3},
  {qnum:16,type:"verbal",skill_id:"v1",text:"اقرأ النص التالي ثم أجب عن السؤال:\n\nلطالما اعتُقِد أن النوم مجرد فترة من الخمول يستريح خلالها الجسد من عناء اليوم، غير أن الدراسات الحديثة في علم الأعصاب كشفت أن الدماغ خلال النوم لا يتوقف عن العمل، بل يدخل في نشاط دؤوب يعيد فيه تنظيم ما اكتسبه من معلومات خلال اليقظة. فحين ننام، تنتقل الذكريات الحديثة المخزَّنة مؤقتاً في منطقة الحُصين إلى مناطق أخرى في القشرة الدماغية، حيث تُرسَّخ بصورة أكثر ثباتاً، فيما يُعرَف بعملية \"توطيد الذاكرة\". ولهذا فسّر الباحثون تراجع القدرة على التذكر لدى من يعانون قلة النوم المزمنة، إذ يُحرم دماغهم من هذه الفرصة الحيوية لإعادة التنظيم. وتشير الأدلة إلى أن مرحلة النوم العميق (البطيء الموجات) ترتبط بشكل خاص بتوطيد الذكريات التصريحية كالحقائق والمعلومات، في حين يبدو توطيد المهارات الحركية أكثر ارتباطاً بتضافر عدة مراحل من النوم لا بمرحلة واحدة بعينها؛ الأمر الذي يجعل من التبسيط المخلّ القول إن مرحلة واحدة فقط هي المسؤولة عن كل أنواع التعلم أثناء النوم.\n\nما الفكرة الرئيسة التي يقوم عليها النص؟",opt1:"لكل نوع من الذاكرة آلية توطيد مرتبطة بمراحل نوم مختلفة، لا بمرحلة واحدة شاملة",opt2:"النوم العميق هو المسؤول الوحيد عن جميع أنواع التعلم وتعزيز الذاكرة",opt3:"قلة النوم لا تؤثر إلا في الذاكرة التصريحية دون سواها لأنها هي الأهم والأقوى تأثراً",opt4:"الحُصين هو المكان النهائي لتخزين جميع الذكريات وهو الفائدة العلمية التي يجب التعرف عليها",ans:0},
  {qnum:17,type:"verbal",skill_id:"v1",text:"اقرأ النص التالي ثم أجب عن السؤال:\n\nلطالما اعتُقِد أن النوم مجرد فترة من الخمول يستريح خلالها الجسد من عناء اليوم، غير أن الدراسات الحديثة في علم الأعصاب كشفت أن الدماغ خلال النوم لا يتوقف عن العمل، بل يدخل في نشاط دؤوب يعيد فيه تنظيم ما اكتسبه من معلومات خلال اليقظة. فحين ننام، تنتقل الذكريات الحديثة المخزَّنة مؤقتاً في منطقة الحُصين إلى مناطق أخرى في القشرة الدماغية، حيث تُرسَّخ بصورة أكثر ثباتاً، فيما يُعرَف بعملية \"توطيد الذاكرة\". ولهذا فسّر الباحثون تراجع القدرة على التذكر لدى من يعانون قلة النوم المزمنة، إذ يُحرم دماغهم من هذه الفرصة الحيوية لإعادة التنظيم. وتشير الأدلة إلى أن مرحلة النوم العميق (البطيء الموجات) ترتبط بشكل خاص بتوطيد الذكريات التصريحية كالحقائق والمعلومات، في حين يبدو توطيد المهارات الحركية أكثر ارتباطاً بتضافر عدة مراحل من النوم لا بمرحلة واحدة بعينها؛ الأمر الذي يجعل من التبسيط المخلّ القول إن مرحلة واحدة فقط هي المسؤولة عن كل أنواع التعلم أثناء النوم.\n\nلماذا يربط النص بين انتقال الذكريات إلى القشرة الدماغية وبين تراجع الذاكرة لدى من يعانون قلة النوم المزمنة؟",opt1:"لأن قلة النوم تمنع حدوث عملية إعادة التنظيم والتوطيد التي تحتاجها الذكريات أثناء النوم",opt2:"لأن الحصين يتوقف عن العمل نهائياً عند قلة النوم وبالتالي تتطلب الذكريات إعادة تنشيط",opt3:"لأن القشرة الدماغية تفقد قدرتها على التخزين نهائياً وهذا يتطلب احتياط الشخص",opt4:"لأن قلة النوم تُسرّع انتقال الذكريات إلى القشرة الدماغية وهذا تفسير لمضمون النص وهدفه",ans:0},
  {qnum:18,type:"verbal",skill_id:"v1",text:"اقرأ النص التالي ثم أجب عن السؤال:\n\nلطالما اعتُقِد أن النوم مجرد فترة من الخمول يستريح خلالها الجسد من عناء اليوم، غير أن الدراسات الحديثة في علم الأعصاب كشفت أن الدماغ خلال النوم لا يتوقف عن العمل، بل يدخل في نشاط دؤوب يعيد فيه تنظيم ما اكتسبه من معلومات خلال اليقظة. فحين ننام، تنتقل الذكريات الحديثة المخزَّنة مؤقتاً في منطقة الحُصين إلى مناطق أخرى في القشرة الدماغية، حيث تُرسَّخ بصورة أكثر ثباتاً، فيما يُعرَف بعملية \"توطيد الذاكرة\". ولهذا فسّر الباحثون تراجع القدرة على التذكر لدى من يعانون قلة النوم المزمنة، إذ يُحرم دماغهم من هذه الفرصة الحيوية لإعادة التنظيم. وتشير الأدلة إلى أن مرحلة النوم العميق (البطيء الموجات) ترتبط بشكل خاص بتوطيد الذكريات التصريحية كالحقائق والمعلومات، في حين يبدو توطيد المهارات الحركية أكثر ارتباطاً بتضافر عدة مراحل من النوم لا بمرحلة واحدة بعينها؛ الأمر الذي يجعل من التبسيط المخلّ القول إن مرحلة واحدة فقط هي المسؤولة عن كل أنواع التعلم أثناء النوم.\n\nيمكن أن يُستنتج من النص أن شخصاً يحصل على قسط كافٍ من ساعات النوم، لكن نومه العميق متقطع باستمرار بفعل اضطرابات صحية، سيكون الأكثر عرضة لضعف:",opt1:"مهاراته الحركية بشكل ملحوظ نتيجة ذلك",opt2:"قدرته على الدخول في النوم من الأساس",opt3:"توطيد الحقائق والمعلومات تحديداً",opt4:"جميع أنواع ذاكرته ومهاراته دون استثناء",ans:2},
  {qnum:19,type:"verbal",skill_id:"v1",text:"اقرأ النص التالي ثم أجب عن السؤال:\n\nلطالما اعتُقِد أن النوم مجرد فترة من الخمول يستريح خلالها الجسد من عناء اليوم، غير أن الدراسات الحديثة في علم الأعصاب كشفت أن الدماغ خلال النوم لا يتوقف عن العمل، بل يدخل في نشاط دؤوب يعيد فيه تنظيم ما اكتسبه من معلومات خلال اليقظة. فحين ننام، تنتقل الذكريات الحديثة المخزَّنة مؤقتاً في منطقة الحُصين إلى مناطق أخرى في القشرة الدماغية، حيث تُرسَّخ بصورة أكثر ثباتاً، فيما يُعرَف بعملية \"توطيد الذاكرة\". ولهذا فسّر الباحثون تراجع القدرة على التذكر لدى من يعانون قلة النوم المزمنة، إذ يُحرم دماغهم من هذه الفرصة الحيوية لإعادة التنظيم. وتشير الأدلة إلى أن مرحلة النوم العميق (البطيء الموجات) ترتبط بشكل خاص بتوطيد الذكريات التصريحية كالحقائق والمعلومات، في حين يبدو توطيد المهارات الحركية أكثر ارتباطاً بتضافر عدة مراحل من النوم لا بمرحلة واحدة بعينها؛ الأمر الذي يجعل من التبسيط المخلّ القول إن مرحلة واحدة فقط هي المسؤولة عن كل أنواع التعلم أثناء النوم.\n\nلو استُبدلت كلمة (تضافر) في النص بكلمة (انفراد)، فإن ذلك سيجعل الجملة:",opt1:"تحمل المعنى نفسه تماماً لأن التضافر هنا يعزز الانفراد",opt2:"توضح المعنى بصورة أدق لأن الانفراد جزء من التضافر",opt3:"تناقض ما يقرره النص عن توطيد المهارات الحركية",opt4:"لا تغيّر من المعنى العلمي للنص شيئاً لكنها تجعل الصياغة ركيكة",ans:2},
  {qnum:20,type:"verbal",skill_id:"v1",text:"اقرأ النص التالي ثم أجب عن السؤال:\n\nلطالما اعتُقِد أن النوم مجرد فترة من الخمول يستريح خلالها الجسد من عناء اليوم، غير أن الدراسات الحديثة في علم الأعصاب كشفت أن الدماغ خلال النوم لا يتوقف عن العمل، بل يدخل في نشاط دؤوب يعيد فيه تنظيم ما اكتسبه من معلومات خلال اليقظة. فحين ننام، تنتقل الذكريات الحديثة المخزَّنة مؤقتاً في منطقة الحُصين إلى مناطق أخرى في القشرة الدماغية، حيث تُرسَّخ بصورة أكثر ثباتاً، فيما يُعرَف بعملية \"توطيد الذاكرة\". ولهذا فسّر الباحثون تراجع القدرة على التذكر لدى من يعانون قلة النوم المزمنة، إذ يُحرم دماغهم من هذه الفرصة الحيوية لإعادة التنظيم. وتشير الأدلة إلى أن مرحلة النوم العميق (البطيء الموجات) ترتبط بشكل خاص بتوطيد الذكريات التصريحية كالحقائق والمعلومات، في حين يبدو توطيد المهارات الحركية أكثر ارتباطاً بتضافر عدة مراحل من النوم لا بمرحلة واحدة بعينها؛ الأمر الذي يجعل من التبسيط المخلّ القول إن مرحلة واحدة فقط هي المسؤولة عن كل أنواع التعلم أثناء النوم.\n\nوفقاً للنص، ما الفرق بين توطيد الذاكرة التصريحية وتوطيد المهارات الحركية أثناء النوم؟",opt1:"لا فرق بينهما، فكلاهما يرتبط حصرياً بمرحلة النوم العميق حيث يحتاج الجسم لذلك .",opt2:"التصريحية ترتبط بشكل خاص بمرحلة النوم العميق، بينما الحركية ترتبط بتضافر عدة مراحل",opt3:"الحركية ترتبط بشكل خاص بمرحلة واحدة، بينما التصريحية تحتاج مراحل متعددة",opt4:"كلتاهما لا علاقة لهما بمراحل النوم إطلاقاً وإنما النوم هو مساعد لهما بشكل نسبي",ans:1},
  {qnum:21,type:"verbal",skill_id:"v3",text:"اختر الكلمة الشاذة:",opt1:"كاتب",opt2:"معطاء",opt3:"مقدام",opt4:"صبور",ans:0},
  {qnum:22,type:"verbal",skill_id:"v3",text:"اختر الكلمة الشاذة:",opt1:"الوغى",opt2:"الوئام",opt3:"الهيجاء",opt4:"الوطيس",ans:1},
  {qnum:23,type:"verbal",skill_id:"v3",text:"اختر الكلمة الشاذة:",opt1:"أرغفة",opt2:"رجال",opt3:"أجمال",opt4:"أفلس",ans:1},
  {qnum:24,type:"verbal",skill_id:"v3",text:"اختر الكلمة الشاذة:",opt1:"زئير",opt2:"عواء",opt3:"خرير",opt4:"نهيق",ans:2},
  {qnum:25,type:"verbal",skill_id:"v3",text:"اختر الكلمة الشاذة:",opt1:"خالد",opt2:"أحمد",opt3:"يزيد",opt4:"عمر",ans:0},
  {qnum:26,type:"quantitative",skill_id:"q1",text:"جهاز قيمته الأصلية 2500 ريال ثم عرضته الشركة بخصم 20% فكم يكون سعره بعد الخصم ؟",opt1:"1800 ريال",opt2:"2000 ريال",opt3:"2200 ريال",opt4:"2300 ريال",ans:1},
  ...
  {qnum:40,type:"quantitative",skill_id:"q1",text:"خزان مُلئ ثلثه ثم أُضيف 12 لتراً فأصبح نصفه ممتلئاً. كم سعة الخزان؟",opt1:"36 لتراً",opt2:"48 لتراً",opt3:"60 لتراً",opt4:"72 لتراً",ans:3},
  ...
  {qnum:49,type:"quantitative",skill_id:"q4",text:"محمد اشترى 5 أقلام و4 دفاتر، وخالد اشترى 4 أقلام و5 دفاتر، ودفع كلاهما نفس المبلغ. قارن بين: (القيمة الأولى) سعر القلم — (القيمة الثانية) سعر الدفتر",opt1:"القيمة الأولى أكبر",opt2:"القيمة الثانية أكبر",opt3:"القيمتان متساويتان",opt4:"المعطيات غير كافية",ans:2},
...
export async function onRequest({ request, env }) {
  ...
  try {
    ...
    if (resource === 'settings') {
      ...
      // access_requests_enabled and whatsapp_dispatch_enabled which are
      ...
      if (!sub && method === 'PATCH') {
        ...
        const ALLOWED_KEYS = new Set(['quiz_pass_ratio', 'student_id_prefix', 'access_requests_enabled', 'whatsapp_dispatch_enabled']);
        if (!ALLOWED_KEYS.has(key)) return err('إعداد غير معروف', 400, CORS);
        if ((key === 'access_requests_enabled' || key === 'whatsapp_dispatch_enabled') && claims.role !== 'dev') return err('هذا الإعداد يُعدَّل من لوحة المطور فقط', 403, CORS);
