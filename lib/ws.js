...
function setupWebSocket(httpServer, env) {
  ...
  wss.on('connection', async (ws, request) => {
    ...
    // different school's connection. The dev-key bypass above hardcodes
    // `claims.school` as undefined, which correctly falls through to '*'
    // here too — the /devtools/monitoring test client is inherently
    // company-wide, same trust level as the dev key everywhere else.
