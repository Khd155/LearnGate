...
const SKILL_GUIDES = {
  v1: {
    what: 'فهم النصوص المقروءة فهمًا دقيقًا، واستخراج الأفكار الرئيسة والفرعية، وتفسير المعاني الضمنية، وتحليل العلاقات بين الجمل، والإجابة عن أسئلة تتطلب فهمًا عميقًا للنص.',
    warning: 'ضعف الأداء في هذه المهارة لا يعني ضعف القراءة، بل غالبًا يعود إلى: القراءة السريعة دون تحليل، والتعامل مع الأسئلة بمعزل عن السياق الكامل، والاعتماد على الذاكرة بدل الفهم.',
    needs: [
  ...
  v2: {
    what: 'تحديد الكلمة التي لا تنسجم مع السياق العام للجملة من حيث المعنى، حتى لو كانت صحيحةً لغويًا في ذاتها.',
    warning: 'ضعف الأداء في هذه المهارة لا يعني ضعف المفردات، بل غالبًا يعود إلى: ضعف فهم السياق العام، والتركيز على الكلمات بشكل منفصل دون ربطها بالمعنى الكلي، والتسرع في الاختيار.',
    needs: [
  ...
  v3: {
    ...
    warning: 'الشذوذ لا يكون في المعنى فقط — قد يكون في التصنيف أو الوظيفة أو العلاقة المفهومية. كما أن الانخفاض في هذه المهارة غالبًا يعكس ضعفًا في "التصنيف الذهني" وليس ضعف المفردات.',
    needs: [
  ...
  v4: {
    ...
    warning: 'انخفاض الأداء لا يعني ضعفًا في جميع أنواع العلاقات — قد تكون متقنًا لبعضها وتحتاج تطويرًا في أخرى. راجع المهارات الفرعية وحدّد أين تحتاج التركيز.',
    needs: [
    ...
    mistakes: [
      ...
      'اختيار أول خيار يبدو متشابهًا موضوعيًا دون التحقق من العلاقة',
    ],
  ...
  v5: {
    ...
    warning: 'ضعف الأداء لا يعني ضعف الفهم اللغوي العام، بل قد يكون ناتجًا عن ضعف في فهم العلاقات داخل الجملة، أو تجاهل أدوات الربط، أو عدم توقع المعنى قبل النظر للخيارات.',
    needs: [
      'فهم السياق العام للجملة قبل النظر للفراغ',
      'أدوات الربط ودلالاتها: لأن، لذلك، رغم، لكن، حتى',
      'التوقع المسبق للإجابة ذهنيًا قبل قراءة الخيارات',
    ...
    mistakes: [
      ...
      'الاعتماد الكامل على الخيارات دون محاولة إكمال الجملة ذاتيًا',
    ],
  ...
  q1: {
    ...
    mistakes: [
      'الخطأ في ترتيب العمليات (الأقواس أولاً دائمًا)',
      'نسيان تحويل الوحدات قبل الحل',
      'الخلط بين التناسب المباشر والعكسي',
      'الخطأ في مسائل الربح والخسارة والخصم',
    ],
    tip: 'ارسم مخططًا بسيطًا للمسألة قبل الحل — يوضح المعطيات ويقلل الأخطاء بشكل كبير.',
  },
  q2: {
    ...
    tip: 'في المتتابعات: احسب الفرق بين حدّين متتاليين — إن كان ثابتًا فهي حسابية، وإن كانت النسبة ثابتة فهي هندسية.',
  },
  q3: {
  ...
  q4: {
    ...
    tip: 'قبل اختيار "غير كافية": بسّط جبريًا أولاً — كثير من الأسئلة تُحل فور التبسيط.',
  },
};
...
const SKILL_QUIZZES = {
  ...
  v3: { title: 'اختبار المفردة الشاذة',              url: '' },
